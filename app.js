...
fastify
    ...
    .register(require('./src/model/govind-book'))
    .register(require('./src/model/govindcapmelting-book'))
    .register(require('./src/model/govindcap-book'))
    .register(require('./src/model/babumelting-book'))
    ...
    .register(require('./src/routes/admin/admin-govindBook'), {prefix: '/admin'})
    .register(require('./src/routes/admin/admin-govindcapMeltingBook'), {prefix: '/admin'})
    .register(require('./src/routes/admin/admin-govindcapBook'), {prefix: '/admin'})
    .register(require('./src/routes/admin/admin-babuMeltingBook'), {prefix: '/admin'})
