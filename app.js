...
fastify
    ...
    // .register(require('./src/model/govind-melting-book'))
    // .register(require('./src/model/govind-tar-patta'))
    // .register(require('./src/model/govind-machine-account'))
    // .register(require('./src/model/govind-dai-bhuka'))
    // .register(require('./src/model/govind-dai-account'))
    ...
    // .register(require('./src/routes/admin/admin-govindMeltingBook'), {prefix: '/admin'})
    // .register(require('./src/routes/admin/admin-govindTarPatta'), {prefix: '/admin'})
    // .register(require('./src/routes/admin/admin-govindMachineAccount'), {prefix: '/admin'})
    // .register(require('./src/routes/admin/admin-govindDaiBhuka'), {prefix: '/admin'})
    // .register(require('./src/routes/admin/admin-govindDaiAccount'), {prefix: '/admin'})
